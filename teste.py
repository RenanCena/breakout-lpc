    ...
    while run:
        ...
        for brick in brick_collision_list:
            ...
            if 238 > brick.rect.y > 198.5:
                score += 1
                brick.kill()
            elif 198.5 > brick.rect.y > 158:
                score += 3
                brick.kill()
            elif 158.5 > brick.rect.y > 119.5:
                score += 5
                brick.kill()
            else:
                score += 7
        ...
        pygame.draw.line(screen, BLUE, [(wall_width / 2) - 1, HEIGHT - 50 + paddle_height / 2 - 54 / 2],
                         [(wall_width / 2) - 1, HEIGHT - 50 + paddle_height / 2 - 54 / 2 + 54], wall_width)
        pygame.draw.line(screen, BLUE, [(WIDTH - wall_width / 2) - 1, HEIGHT - 50 + paddle_height / 2 - 54 / 2],
                         [(WIDTH - wall_width / 2) - 1, HEIGHT - 50 + paddle_height / 2 - 54 / 2 + 54], wall_width)
